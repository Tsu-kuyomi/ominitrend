function t396_init(t) {
  ...
  l &&
    ...
    (window.tn["ab" + t].scaleFactor = parseFloat(
    ...
    r &&
      a &&
      l &&
      "yes" === r.getAttribute("data-connect-with-tab") &&
      a.addEventListener("displayChanged", function () {
        t396_allelems__renderView(l),
          t396_allgroups__renderView(l),
          t396_doResize(t);
      }),
    setTimeout(function () {
      r &&
        r.closest("#allrecordstable") &&
        a &&
        l &&
        a.addEventListener("displayChanged", function () {
          t396_allelems__renderView(l),
    ...
    r &&
      ...
      a &&
      l &&
      a.addEventListener("animationInited", function () {
        t396_allelems__renderView(l),
          t396_allgroups__renderView(l),
          t396_doResize(t);
      }),
    /^((?!chrome|android).)*safari/i.test(navigator.userAgent) &&
      a &&
      a.classList.add("t396_safari"),
    (n = "window" === t396_ab__getFieldValue(l, "upscale")),
    ...
    o ||
      "y" !== t396_ab__getFieldValue(l, "fixed-need-js") ||
      t_onFuncLoad("t396__processFixedArtBoard", function () {
        t396__processFixedArtBoard(l);
      }),
    t396__processAbsoluteArtBoard(l),
    t396__processTopShift(l, t, !1));
}
...
function t396_doResize(t) {
  var e = t396_isOnlyScalableBrowser(),
    ...
    r =
      ...
      e
        ? ((e = i ? i.querySelectorAll(".tn-molecule, .tn-atom") : []),
  ...
  (e = "ab" + t),
    (i = r ? r.clientWidth : 0),
    (window.tn_window_width = document.documentElement.clientWidth),
    (window.tn[e].scaleFactor = parseFloat(
    ...
    t396_updateTNobj(t),
    t396_ab__renderView(r),
    (e = n ? n.getAttribute("data-tilda-mode") : "");
  "window" === t396_ab__getFieldValue(r, "upscale") &&
    "edit" !== e &&
    t_onFuncLoad("t396_scaleBlock", function () {
      t396_scaleBlock(t);
    }),
...
function t396_updateTNobj(t) {
  ...
  t
    ...
    (window.tn.window_height = window.t396__isMobile
      ...
      : window.innerHeight);
  for (var o = window.tn[e].screens.slice().reverse(), r = 0; r < o.length; r++)
    window.tn[e].curResolution === o[r] &&
      ((window.tn[e].canvas_min_width = o[r]),
      (window.tn[e].canvas_max_width =
        0 === r ? window.tn.window_width : o[r - 1]));
...
function t396_artboard_build(t, e) {
  ...
  ("visible" !== a && "visibleX" !== a) ||
    ...
    document.querySelector(".t951__sidebar_sticky") &&
...
function t396_elem__renderViewOneField(t, e) {
  if ((t = t396_getEl(t))) {
    var i = (i = document.getElementById("allrecords"))
        ? i.getAttribute("data-tilda-mode")
        : "",
      n =
        "window" ===
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  if ((t = t396_getEl(t))) {
    var o = (n = t.closest(".t396__artboard")).getAttribute(
        "data-artboard-recid"
      ),
      r = "ab" + o,
      ...
      d =
        "edit" ===
        ((n = document.getElementById("allrecords"))
          ? n.getAttribute("data-tilda-mode")
          : ""),
    ...
    switch (e) {
      case "left":
        ...
        !d && l ? "grid" === g && _ && (i *= m) : (i = b + i),
          ...
          s &&
            "window" !== f &&
            (i += ((x = t396_elem__getWidth(t)) * m - x) / 2);
        break;
      case "top":
        function v(t) {
          var e,
        ...
        l && !d && x && (A = parseInt(b, 10) * m),
          "center" === c &&
            ...
            d ||
              ...
              "window" === f ||
              "stretch" !== a ||
              ((y = A ? (E < A ? A : E) : F.clientHeight), (y /= m)),
            (i = y / 2 - V / 2 + i)),
          "bottom" === c &&
            ((V = v(t)),
            s &&
          ...
          s &&
            "window" !== f &&
            ((x = ((V = v(t)) * m - V) / 2), (i += x = Math.round(x)));
    }
    return i;
  }
}
